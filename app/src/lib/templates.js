...
<p style="font-family: 'Josefin Slab Variable', Rockwell, serif"><strong>Josefin Slab.</strong> Thin, elegant strokes on a geometric skeleton — art-deco proportions with slab feet, closer to a 1920s poster face than a textbook. Unusually light-footed for a slab.</p>
<p style="font-family: 'Rokkitt Variable', Rockwell, serif"><strong>Rokkitt.</strong> A geometric slab with softened, slightly rounded corners — friendlier than a strict geometric skeleton, still built on an even, modern rhythm.</p>
<p style="font-family: 'Fjalla One', Rockwell, serif"><strong>Fjalla One.</strong> Tall, narrow, single-weight — a condensed slab built for headlines and labels, not paragraphs. A deliberate special-purpose face: right for a dense heading, wrong for a full page. No italic exists; Word will slant it synthetically.</p>
...
<p style="font-family: 'Abril Fatface', Georgia, serif"><strong>Abril Fatface.</strong> Ultra-bold, poster-weight Didone — thick, confident strokes with almost no thin-and-thick swing left to speak of. One weight only, and no interest in being subtle. Right for a cover word, wrong for a full title.</p>
<p style="font-family: 'Instrument Serif', Georgia, serif"><strong>Instrument Serif.</strong> Quirky, slightly compressed, with an unusually characterful italic — a face with a strong point of view rather than a workhorse. Reads as very of-the-moment.</p>
<p style="font-family: 'Libre Caslon Display', Georgia, serif"><strong>Libre Caslon Display.</strong> A bold, confident Caslon — the English old-style tradition rather than Playfair's transitional one. Sturdier strokes, less contrast, reads as printed and permanent.</p>
<p style="font-family: 'Young Serif', Georgia, serif"><strong>Young Serif.</strong> Rounded terminals and a generous x-height soften every letter — the most approachable face in the Display category, closer to a children's book cover than a literary one.</p>
<p style="font-family: 'Bricolage Grotesque Variable', -apple-system, sans-serif"><strong>Bricolage Grotesque.</strong> The one non-serif in the Display category — a variable grotesque with real personality in its curves and terminals, expressive without being a script or a novelty face. No italic exists; Word will slant it synthetically.</p>
